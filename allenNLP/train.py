...
def train(data, task):
    # トレーニングコマンドの実行
    train_command = f"allennlp train --serialization-dir exp/{data}/exp-{data}-{task} --force --include-package src.model --include-package src.dataset_reader --include-package src.tokenizer jsons/{data}/{data}-{task}.jsonnet"
